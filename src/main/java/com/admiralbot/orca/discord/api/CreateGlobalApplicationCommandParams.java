...
@Builder
public record CreateGlobalApplicationCommandParams(
    ...
    public static String getPath(String applicationId) {
        return String.format("/applications/%s/commands", applicationId);
    }
}
